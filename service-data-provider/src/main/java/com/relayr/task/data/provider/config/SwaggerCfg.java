package com.relayr.task.data.provider.config;
...
public class SwaggerCfg {
    ...
    /**
     * Group Data contains data operations
     */
    @Bean
    public Docket swaggerProductApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Product")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.relayr.task.data.provider.restapi.v1"))
